  ...
  return (
    <React.Fragment>
      ...
      <div className="d-flex justify-content-between flex-wrap mx-auto mb-2" style={{maxWidth: 550}}>
        ...
        <button className="mb-3 btn btn-outline-secondary btn-sm" style={{minWidth: 125}} onClick={() => createToast({ header: 'Secondart Toast:', theme: 'secondary'})}>Secondary Toast</button>
        <button className="mb-3 btn btn-outline-success btn-sm"   style={{minWidth: 125}} onClick={() => createToast({ theme: 'success' })}>Success Toast</button>
